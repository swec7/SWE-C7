...
public class Hauptpane extends BorderPane {
	...
	public Hauptpane(HostServices services) {
		...
		VBox box = new VBox();
		box.getStyleClass().add("box"); // F�gt dem Object eine style Class aus
										// der CSS datei hinzu
		...
		hStart.getChildren().add(startText); // F�gt einem JavaFX Object Objects
												// hinzu
		...
		start.setHostServices(services); // setzt die HostServices f�r das Tab
											// (wird beim Hyperlink ben�tigt)
