...
//		System.out.println("[1]DEBUG");
		try {
//			System.out.println(studiengangDaten.get(0)+ " " + studiengangDaten.get(2)+ " " + studiengangDaten.get(1)+ " " + studiengangDaten.get(3)+ " " + studiengangDaten.get(4));
			//System.out.println(studiengangDaten.get(5)+ " " + studiengangDaten.get(6)+ " " + studiengangDaten.get(7)+ " " + studiengangDaten.get(8)+ " " + studiengangDaten.get(9));
...
//			System.out.println("[T5]DEBUG");
			...
			throw new CSVLeseException("Ungültiger Wert");
			//throw new CSVLeseException(studiengangDaten.get(0)+ " " + studiengangDaten.get(2)+ " " + studiengangDaten.get(1)+ " " + studiengangDaten.get(3)+ " " + studiengangDaten.get(4));
		} catch (IndexOutOfBoundsException e) {
			throw new CSVLeseException("Fehlender Wert");
		}
