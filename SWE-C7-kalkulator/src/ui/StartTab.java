...
public class StartTab extends QisTab{
	...
	public StartTab(){
		...
		GridPane.setMargin(anleitungBox, new Insets(0, 60, 0, 0)); 	//setzt margin F?r die Anleitung (Ber?hrt nicht das Logo)
		...
		qisLink.setOnAction((ActionEvent event)->{
			super.getHostServices().showDocument("https://www.qis.fh-aachen.de"); 	// ?ffnet den Browser zur QIS-Seite		
		});
...
//		qisLink.setWrapText(true);
		...
		WrapLabel anleitung4 = new WrapLabel("Importieren Sie nun die HTML-Datei mit hilfe des '...' Buttons."
				+ "Wählen Sie im geöffneten Datei-Browse die entsprechende Datei aus und best?tigen Sie die"
		...
		GridPane.setHgrow(anleitungBox, Priority.ALWAYS); // Gibt an ob das Element bei resizing Horizontal gr??er werden soll/darf 
